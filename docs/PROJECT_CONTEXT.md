...
- Development VM: VM 100 `mnt-mate` (Linux Mint) - **decided 24/08/2026 that it leaves this hypervisor**. It is already powered off and will be removed. That closes the open question about its network zone, which had been outstanding since 28/07/2026, and frees the 8GB allocation it held.
